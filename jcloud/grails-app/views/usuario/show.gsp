            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Plano:</td>
                            
                            <td valign="top" class="value"><g:link controller="plano" action="show" id="${usuario?.plano?.id}">${usuario?.plano?.encodeAsHTML()}</g:link></td>
