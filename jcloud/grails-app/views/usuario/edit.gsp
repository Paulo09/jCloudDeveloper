                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:usuario,field:'plano','errors')}">
                                    <g:select optionKey="id" from="${Plano.list()}" name="plano.id" value="${usuario?.plano?.id}" noSelection="['null':'']"></g:select>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:usuario,field:'aplicacao','errors')}">
                                    
<ul>
<g:each var="a" in="${usuario?.aplicacao?}">
    <li><g:link controller="aplicacao" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></li>
</g:each>
</ul>
<g:link controller="aplicacao" params="['usuario.id':usuario?.id]" action="create">Add Aplicacao</g:link>
